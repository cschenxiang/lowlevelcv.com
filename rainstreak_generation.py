...
if __name__ == '__main__':
    ...
    parser.add_argument("--input_dir", type=str, default='./input/*.png')
    ...
    for file in glob.glob(config.input_dir):
        process(img_name = file,
                ...
                noise = random.randint(300, 500),#100,150,200,250,300
                rain_len = random.randint(20, 40),#20,30,40
                rain_angle = random.randint(-10, 40),#-40,-30,-20,-10,0,10,20,30,40
